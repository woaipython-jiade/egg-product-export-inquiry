...
**Source**: [APQA Animal Quarantine](https://www.qia.go.kr/english/html/Animal_livestock/ani_livestock_import-E.jsp)
...
- MFDS publishes **non-compliant import results** online — [MFDS Import Food Inspection Results](https://www.foodsafetykorea.go.kr/portal/board/boardDetail.do)

**Source**: [MFDS Imported Food Safety (Korean)](https://www.mfds.go.kr/wpge/m_659/de010602l001.do) | [MFDS English Portal](https://www.mfds.go.kr/eng/index.do)
...
- **Full Korean Food Code**: [https://www.foodsafetykorea.go.kr/foodcode/](https://www.foodsafetykorea.go.kr/foodcode/)
...
|-----------|------|---------|
| **MFDS** (식품의약품안전처) | Food safety, import inspection, facility registration, MRLs, labeling | [www.mfds.go.kr](https://www.mfds.go.kr) |
| **APQA** (농림축산검역본부) | Animal quarantine, HPAI controls, veterinary certificates | [www.qia.go.kr](https://www.qia.go.kr) |
| **MAFRA** (농림축산식품부) | Agricultural policy, livestock industry oversight | [www.mafra.go.kr](https://www.mafra.go.kr) |
| **KCS** (관세청) | Customs, tariff administration, FTA implementation | [www.customs.go.kr](https://www.customs.go.kr) |
| **Food Safety Korea** | Integrated food safety information portal | [www.foodsafetykorea.go.kr](https://www.foodsafetykorea.go.kr) |
...
- [ ] **Check APQA HPAI suspension status** for Chinese poultry/egg products — [APQA website](https://www.qia.go.kr)
- [ ] Confirm GACC registration (Decree 248/249) covers Korea-destined exports
- [ ] Register manufacturing facility with MFDS through [IFIS system](https://impfood.mfds.go.kr)
...
- [ ] Check FTA tariff classification — [KCS UniPass](https://unipass.customs.go.kr/clip/index.do)
