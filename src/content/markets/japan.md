...
|-----------|------|---------|
| MHLW | Food safety, import inspection, positive list, FAINS system | [www.mhlw.go.jp](https://www.mhlw.go.jp) |
| MAFF | Animal quarantine, HPAI controls | [www.maff.go.jp](https://www.maff.go.jp) |
| MHLW Quarantine Stations | Port-level import inspection | [www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/shokuhin/yunyu_kanshi/](https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/shokuhin/yunyu_kanshi/) |
| FFCR | MRL database maintenance | [db.ffcr.or.jp](http://db.ffcr.or.jp/front/) |
...
- [ ] Check FFCR MRL database ([db.ffcr.or.jp](http://db.ffcr.or.jp/front/)) for all substances used in production
