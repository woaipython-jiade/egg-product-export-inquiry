...
priority: 3
summary: "Malaysia requires three-layer authorization: DVS facility registration, JAKIM-recognized halal certification, and MAQIS import permits. CRITICAL: JAKIM withdrew recognition of China Islamic Association (CIA) in February 2025 — only 5 Chinese halal CBs remain recognized."
summaryZh: "马来西亚需三层授权：DVS设施注册、JAKIM认可清真认证和MAQIS进口许可。重要：JAKIM于2025年2月撤销中国伊斯兰教协会（CIA）认可——仅剩5家中国清真认证机构获认可。"
---
...
- **DVS R5** (revised 29 July 2024): "Requirements for the Importation of Egg Powder into Malaysia"
  - [DVS R5 PDF](https://www.dvs.gov.my/dvs/resources/user_1/2025/BKPBV/IMPORT%20EKSPORT/(R5)_Egg_Products-Any_Country-_Revised_290724.pdf)
- **General Procedure**: [Import of Meat, Poultry, Milk and Egg Products (March 2023)](https://www.dvs.gov.my/dvs/resources/user_1/2023/BRV/LOJI%20LUAR%20NEGARA/UPDATE_MARCH_2023.GENERAL_PROCEDURE_IMPORT_MEAT,_POULTRY,_MILK_AND_EGG_PRODUCTS_TO_MALAYSIA_.REV_1_._30012023_.pdf)
...
| 5 | Facility listing | Upon approval, facility is listed in the **e-Dagang** system |
...
- [JAKIM Official Announcement](https://myehalal.halal.gov.my/portal-halal/v1/index.php?data=bW9kdWxlcy9jb250ZW50X2RldGFpbHM7Ozs%3D&page_title=Announcement&content_id=2025031367d238e5c4bba)
...
| No. | Certification Body | Location |
|-----|-------------------|----------|
| 1 | **Shandong Halal Certification Service (SHC)** | Jinan, Shandong |
| 2 | **ARA Halal Certification Services Centre Inc. (ARA)** | Zhengzhou, Henan |
| 3 | **Linxia Halal Food Certification Centre** | Linxia City, Gansu |
| 4 | **Shaanxi Shang Pin Yuan Halal Food & Restaurant Management (SSPY)** | Shaanxi |
| 5 | **Halal Certification Services Chongqing (HCS)** | Chongqing |

**Verify the latest list**: [JAKIM FHCB List](https://myehalal.halal.gov.my/portal-halal/v1/index.php?data=bW9kdWxlcy9jb2xsYXBzaWJsZV9jb250ZW50Ozs7Ow%3D%3D&utama=CB_LIST)

- PDF (25 Feb 2025): [CBLIST-25FEBRUARY2025.pdf](https://myehalal.halal.gov.my/portal-halal/v1/pdf/cb/CBLIST-25FEBRUARY2025.pdf)
- PDF (29 Aug 2025): [FHCB29082025.pdf](https://myehalal.halal.gov.my/portal-halal/v1/pdf/cb/FHCB29082025.pdf)
...
| Document | Issued By |
|----------|-----------|
| Valid MAQIS Import Permit | MAQIS (via e-Permit) |
| Veterinary Health Certificate (English) | GACC/local customs |
| JAKIM-recognized Halal Certificate | Recognized Chinese CB |
| Certificate of Analysis | Recognized laboratory |
| Certificate of Origin | Chinese chamber of commerce / customs |
| Commercial Invoice | Exporter |
| Packing List | Exporter |
| Bill of Lading / Airway Bill | Carrier |
...
| Regulation | Product |
|-----------|---------|
| Reg 171 | Egg (general definition) |
| Reg 172 | Liquid egg |
| Reg 173 | Liquid egg yolk |
| Reg 174 | Liquid egg white |
| Reg 175 | Dried egg, dried egg yolk, dried egg white |
| Reg 176–178 | Additional egg product standards |

Full text: [Food Regulations 1985 (updated October 2024)](https://hq.moh.gov.my/fsq/xs/dl.php?filename=Food+Regulation+1985+Update+291024+(PUA+209_2020).pdf)
...
| E. coli | Per Food Regulations limits |
...
|-------------|-----------|
| Lead, cadmium, mercury | Food Regulations 1985, Fourteenth Schedule |
| Veterinary drug residues | Aligned with Codex Alimentarius |
| Pesticide residues | Sixteenth Schedule |
| Aflatoxins | Food Regulations (strict enforcement) |

### Labeling Requirements (Food Regulations 1985)

| Requirement | Detail |
|-------------|--------|
| Language | **Bahasa Malaysia or English** (mandatory); additional languages permitted alongside |
| Product name | Appropriate designation of the food |
| Ingredients list | Descending order by weight |
| Net weight/volume | Metric units |
| Date marking | "Best before" or "Use by" |
| Manufacturer/packer | Name and business address |
| Importer | Name and business address in Malaysia |
| Country of origin | Mandatory for all imported food |
| Halal mark | If certified — must follow prescribed JAKIM logo format |
| Nutrition panel | Energy, protein, carbohydrate, total sugar, fat, sodium |
| Allergen declaration | Eggs are a mandatory allergen |
| Font size | Minimum **10-point font**; conspicuous and prominent |
...
|------------|-----------|---------|
| **Food Act 1983** (Act 281) | MOH | Primary food safety legislation |
| **Food Regulations 1985** (P.U.(A) 437/85) | MOH / FSQD | Detailed standards, labeling, contaminants |
| **Trade Descriptions Act 2011** | MDTCC | Halal trade description enforcement |
| **Animals Act 1953** | DVS | Animal product import controls |
| **Malaysian Quarantine and Inspection Services Act 2011** | MAQIS | Border quarantine and inspection |

| Authority | Role | Website |
|-----------|------|---------|
| **DVS** | Facility registration, veterinary health requirements, e-Dagang | [www.dvs.gov.my](https://www.dvs.gov.my) |
| **JAKIM** | Halal certification recognition | [myehalal.halal.gov.my](https://myehalal.halal.gov.my/portal-halal/v1/) |
| **MAQIS** | Import permits, border inspection | [www.maqis.gov.my](https://www.maqis.gov.my) |
| **FSQD (MOH)** | Food safety standards, FOSIM | [fsq.moh.gov.my](https://fsq.moh.gov.my) |
| **GACC** | Chinese export registration, VHC issuance | [www.customs.gov.cn](https://www.customs.gov.cn) |
...
- JAKIM FHCB List (current): [FHCB List Page](https://myehalal.halal.gov.my/portal-halal/v1/index.php?data=bW9kdWxlcy9jb2xsYXBzaWJsZV9jb250ZW50Ozs7Ow%3D%3D&utama=CB_LIST)
- JAKIM CIA Withdrawal Announcement: [Announcement](https://myehalal.halal.gov.my/portal-halal/v1/index.php?data=bW9kdWxlcy9jb250ZW50X2RldGFpbHM7Ozs%3D&page_title=Announcement&content_id=2025031367d238e5c4bba)
