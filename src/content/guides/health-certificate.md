...
1. **Document review** — Verify completeness of submitted documents, consistency between contract/product spec/test report
2. **Laboratory testing** — May require:
...
3. **Facility check** — If due for periodic review, may conduct a brief facility inspection
4. **Packaging and labeling verification** — Confirm labels meet destination country requirements
...
1. Your local customs office (they maintain bilateral certificate templates)
2. The destination country's importer (they know what their customs authority accepts)
